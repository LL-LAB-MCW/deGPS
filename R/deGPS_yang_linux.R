...
ecdfFunMulti(i, maxIter = ceiling(maxIter / ncpu), dataNormal = dataNormal, method = method, group = group, paired = paired, combAllTotal = combAllTotal,
...
paired = FALSE, maxIter = 150, geneid = NULL){
...
mRnaEcdfRes1 <- mRnaEcdfOther(dataSim = data, dataNormal = dataNormal, ecdf = empirical.T.stats,
